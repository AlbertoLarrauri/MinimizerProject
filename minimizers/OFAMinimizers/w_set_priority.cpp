...
#include "w_set_priority.h"

using namespace SBCMin::OFAMinimizers;


void WSetPriority::init() {
...
void WSetPriority::generateVars() {
    resize(upper_bound);
...
void WSetPriority::buildCoveringClauses() {
...
void WSetPriority::buildSymmetryBreakingClauses() {
...
bool WSetPriority::query(int size) {
    current_size=size;
